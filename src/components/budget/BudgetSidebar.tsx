...
export function BudgetSidebar({ darkMode, setDarkMode }: BudgetSidebarProps) {
  return (
...
>>>>>>> 54b5019e4b75a43c30cd948f63b0f6b8185d050d
      ...
      <nav className="mt-12 space-y-2" aria-label="Primary navigation">
        {navItems.map((item, i) => {
          ...
          const isActive = item.label === "Budget";
          ...
          return (
            <motion.a
              ...
              whileHover={{ x: 2 }}
              className={cn(
                "flex h-14 w-full items-center gap-4 rounded-2xl px-4 text-left text-[15px] font-semibold transition-all duration-300",
                isActive
