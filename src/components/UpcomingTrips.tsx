    ...
    <section aria-labelledby="upcoming-trips-title">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        {trips.map((trip, index) => (
          <a key={trip.title} href="#/my-trips">
            <motion.article
              ...
              whileHover={{ y: -8 }}
              className="group overflow-hidden rounded-3xl bg-parchment shadow-travel transition-all duration-300 hover:shadow-float cursor-pointer h-full"
            >
